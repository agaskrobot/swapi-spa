...
export function DetailsCard({ episode }) {
  ...
  return (
    <div className="flex group flex-col justify-between mt-6 p-5 m-10 text-xs sm:text-base w-64 sm:w-96 md:w-100 h-auto text-gray-100 bg-white rounded-lg shadow-lg">
